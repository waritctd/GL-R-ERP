...
description: Use when writing, debugging, or de-flaking Playwright tests — selectors, fixtures, Page Object Model, mocking, auth, CI config, and visual / accessibility / component / API / performance testing. This repo's only e2e suite is Playwright (frontend/e2e-real).
license: MIT
metadata:
  author: currents.dev
  version: "1.2"
