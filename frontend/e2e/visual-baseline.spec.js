...
//
// Usage, per migration slice:
//   1. On the unchanged tree:
//        VISUAL_BASELINE=1 npx playwright test visual-baseline --update-snapshots
//   2. Make the change.
//   3. VISUAL_BASELINE=1 npx playwright test visual-baseline
