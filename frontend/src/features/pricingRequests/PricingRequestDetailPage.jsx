                  ...
                  {isImport(user) && quote.current && ['DRAFT', 'REQUESTED', 'RESPONSE_RECEIVED', 'NEGOTIATING', 'READY_FOR_COSTING'].includes(quote.status) ? (
                    <div className="mt-3 flex flex-col gap-2 border-t border-border-subtle pt-3">
                      ...
                      {draft.items.map((line, index) => {
                        ...
                        return (
                          <div key={line.pricingRequestItemId} className="grid items-end gap-2 md:grid-cols-[1fr_auto_auto_auto]">
                            ...
                            {line.unitBasis === 'PER_SQM' ? (
                              <FormField label="ตร.ม./หน่วย" htmlFor={`pcr-quote-sqm-${quote.id}-${line.pricingRequestItemId}`}>
                                <input
