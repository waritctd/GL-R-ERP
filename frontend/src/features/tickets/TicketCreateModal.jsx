...
// Moved to utils/deriveSqmPerPiece.js (SPEC-PREFILL.md ladder B, 2026-09) — PricingRequestDetailPage.jsx's
// own prefill needs the SAME geometric derivation; imported (not re-defined) so the two call sites
// cannot drift apart. Nothing outside this file imported the old local definition, so no re-export
// is needed here.
