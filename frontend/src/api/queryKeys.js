...
export const queryKeys = {
  ...
  importProgressAll: () => ['importProgress', 'all'],
  importProgressForPricingRequest: (id) => ['importProgress', 'byPricingRequest', id],
  importProgressForTicket: (ticketId) => ['importProgress', 'byTicket', ticketId],
