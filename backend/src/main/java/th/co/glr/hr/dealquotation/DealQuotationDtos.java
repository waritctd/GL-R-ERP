...
public final class DealQuotationDtos {
    ...
    public record DealQuotationDto(
        ...
        /** The pre-V178 shape (no {@link #validityMode}/{@link #validityUntil}) — kept so every
         * existing construction site (tests, mostly) compiles unchanged. Defaults to
         * {@code DAYS}/{@code null}, which reads as the day-count behaviour every one of those
         * fixtures actually means. */
