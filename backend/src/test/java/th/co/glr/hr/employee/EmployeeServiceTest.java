...
class EmployeeServiceTest {
    ...
    void logsAuditEventWhenHrViewsSensitiveDetail() {
        ...
        service.get(5L, new UserPrincipal(7L, "hr@glr.co.th", "HR", "hr", 10L, true, LocalDate.now()));
    ...
    void doesNotLogAuditEventForSelfServiceView() {
        ...
        service.get(5L, new UserPrincipal(8L, "e@glr.co.th", "E", "employee", 5L, true, LocalDate.now()));
